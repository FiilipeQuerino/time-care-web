      ...
      <main className="flex-1 p-4 md:p-10 max-w-7xl mx-auto w-full overflow-x-hidden">
        ...
        <header className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
             ...
             <div className="bg-white p-2 rounded-xl border border-rose-50 shadow-sm relative cursor-pointer hover:bg-rose-50 transition-colors">
                <div className="absolute top-1 right-1 w-2 h-2 bg-pink-500 rounded-full border-2 border-white"></div>
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-400"><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/></svg>
             </div>
          </div>
        </header>
